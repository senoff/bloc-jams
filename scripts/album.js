...
var nextSong = function() {
    ...
    // this deals with the next song wrapping around to the first song
...
var previousSong = function() {
    getLastSongNumber = function(index) {
        // Rob - definitely want to run through this one with you.
    ...
    // this deals with the next song wrapping
    if (currentSongIndex < 0) {
        // Rob - and this -1 here too
...
var togglePlayFromPlayerBar = function() {
    if (currentSoundFile.isPaused()) {
        ...
        $currentPlayerBarPlay.html($currentPlayerBarPlayButton);
        currentSoundFile.pause();
    }
 };
...
var $currentPlayerBarPlay = $('.main-controls .play-pause');

$(document).ready(function() {
    setCurrentAlbum(albumPicasso);
    currentSongFile = currentAlbum.songs[0].audioUrl;
//    setupSeekBars();
    $previousButton.click(previousSong);
    $nextButton.click(nextSong);
    $currentPlayerBarPlay.click(togglePlayFromPlayerBar());
